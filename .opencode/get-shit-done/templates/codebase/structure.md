...
- Usage: Reference from command with `@/Users/richardhightower/clients/spillwave/src/agent-brain/.opencode/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/richardhightower/clients/spillwave/src/agent-brain/.opencode/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/richardhightower/clients/spillwave/src/agent-brain/.opencode/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
