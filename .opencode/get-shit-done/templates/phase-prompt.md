...
<!-- For checkpoint task examples and patterns, see @/Users/richardhightower/clients/spillwave/src/agent-brain/.opencode/get-shit-done/references/checkpoints.md -->
...
See `/Users/richardhightower/clients/spillwave/src/agent-brain/.opencode/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `/Users/richardhightower/clients/spillwave/src/agent-brain/.opencode/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `/Users/richardhightower/clients/spillwave/src/agent-brain/.opencode/get-shit-done/workflows/verify-phase.md` for verification logic.
