...
<required_reading>
@/Users/richardhightower/clients/spillwave/src/agent-brain/.opencode/get-shit-done/references/continuation-format.md
</required_reading>
...
```bash
INIT=$(node "/Users/richardhightower/clients/spillwave/src/agent-brain/.opencode/get-shit-done/bin/gsd-tools.cjs" init resume)
