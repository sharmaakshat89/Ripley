...
- **Global scope**: `/Users/richardhightower/clients/spillwave/src/agent-brain/.opencode/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/richardhightower/clients/spillwave/src/agent-brain/.opencode/notes/`)
...
2. Glob `/Users/richardhightower/clients/spillwave/src/agent-brain/.opencode/notes/*.md` (if directory exists) — global notes
...
Global (/Users/richardhightower/clients/spillwave/src/agent-brain/.opencode/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/richardhightower/clients/spillwave/src/agent-brain/.opencode/notes/` — works in any directory
